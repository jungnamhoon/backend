...
public enum ErrorCode {
  ...
  PROBLEM_ALREADY_TRIED(HttpStatus.BAD_REQUEST,"MP001","제출번호가 똑같습니다"),
  RECOMMENDATION_DATA_NOT_FOUND(HttpStatus.BAD_REQUEST, "AN-001", "분석된 취약점 데이터가 부족하여 추천을 생성할 수 없습니다.");
